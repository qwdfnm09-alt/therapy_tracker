...
class InLawsGuideScreen extends StatelessWidget {
  const InLawsGuideScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final sections = repository.inLawsGuideSections();
    ...
    return AppPage(
      ...
      child: ListView(
        ...
        children: [
          SectionCard(
            title: context.tr('inLawsGuideIntroTitle'),
            icon: Icons.people_outline_rounded,
            child: Text(context.tr('inLawsGuideIntroBody')),
          ),
