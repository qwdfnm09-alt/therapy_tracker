...
class RightsAndDutiesScreen extends StatelessWidget {
  const RightsAndDutiesScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final sections = repository.rightsAndDutiesSections();
    ...
    return AppPage(
      ...
      child: ListView(
        ...
        children: [
          SectionCard(
            title: context.tr('rightsAndDutiesIntroTitle'),
            icon: Icons.gavel_rounded,
            child: Text(context.tr('rightsAndDutiesIntroBody')),
          ),
...
class _RightItemTile extends StatelessWidget {
