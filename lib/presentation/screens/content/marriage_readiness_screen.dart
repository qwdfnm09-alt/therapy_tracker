...
class MarriageReadinessScreen extends StatelessWidget {
  const MarriageReadinessScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final sections = repository.marriageReadinessSections();
    ...
    return AppPage(
      ...
      child: ListView(
        ...
        children: [
          SectionCard(
            title: context.tr('marriageReadinessIntroTitle'),
            icon: Icons.verified_user_outlined,
            child: Text(context.tr('marriageReadinessIntroBody')),
          ),
